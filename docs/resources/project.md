...
- `tags` (Map of List of String) Tags of `meshProject`. Only the tags you declare here are managed by Terraform; restricted-tag defaults meshStack injects are not tracked and never show as drift.
