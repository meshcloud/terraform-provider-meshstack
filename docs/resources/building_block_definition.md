  ...
  version_spec = {
    ...
    inputs = {
      ...
      deploy_settings = {
        ...
        type            = "JSON_SCHEMA"
        assignment_type = "USER_INPUT"
        # Optional: only asked for while this CEL expression over the other user inputs holds. While it
        # does not, meshStack sends no value and the module falls back to its own default.
