...
description: |-
  ...
  ~> Deprecated: Use the meshstack_tenants data source instead.
...
- `quotas` (Attributes List) The effective quotas meshStack applied to this tenant. (see [below for nested schema](#nestedatt--status--quotas))
