...
require (
	...
	github.com/meshcloud/meshstack-cli v0.1.1-0.20260924131803-7a85b44d0f9a
...
// Post-split, so googleapis/rpc/status comes from one module only. A Go workspace turns off
// module-graph pruning, which otherwise hides the pre-split genproto that golangci-lint pulls in.
