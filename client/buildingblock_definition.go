...
var (
	MeshBuildingBlockTypes              = types.Enum[MeshBuildingBlockType]{}
...
type MeshBuildingBlockDefinitionMetadataAdapter[String any] struct {
	...
	MarkedForDeletionOn String `json:"markedForDeletionOn,omitempty" tfsdk:"marked_for_deletion_on"`
...
type MeshBuildingBlockDefinitionSpec struct {
	...
	NotificationSubscriberUsernames []string              `json:"notificationSubscriberUsernames,omitempty" tfsdk:"notification_subscriber_usernames"`
}
