...
type MeshBuildingBlockDefinitionVersionSpecAdapter[Input, RunnerRef, DependencyRef, Secret, State, Number any] struct {
	...
	RunnerRef                 RunnerRef                                         `json:"runnerRef" tfsdk:"runner_ref"`
	DependencyDefinitionUUIDs []DependencyRef                                   `json:"dependencyDefinitionUuids,omitempty" tfsdk:"dependency_refs"`
...
type MeshBuildingBlockDefinitionVersionSpec = MeshBuildingBlockDefinitionVersionSpecAdapter[
	*MeshBuildingBlockDefinitionInput,
	BuildingBlockRunnerRef,
	types.String, // DependencyRef
	*types.Secret,
