...
func TestAccPaymentMethod(t *testing.T) {
	config, resourceAddress, wsAddr := testconfig.BuildPaymentMethodConfig(t)

	updateConfig := config.WithFirstBlock(t,
		testconfig.Traverse(t, "spec", "display_name")(testconfig.SetString("Updated Payment Method")))
