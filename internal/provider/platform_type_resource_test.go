...
func TestAccPlatformType(t *testing.T) {
	config, platformTypeAddr := testconfig.BuildPlatformTypeAndWorkspaceConfig(t)
	...
	updatedConfig := config.WithFirstBlock(t,
		testconfig.Traverse(t, "spec", "display_name")(testconfig.SetString("My Custom Platform Updated "+updateSuffix)),
	)
