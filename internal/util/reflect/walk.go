...
type (
	...
	WithKeyVisitor = withVisitor[MapKey]
)
...
type (
	...
	WithFieldNameVisitor = withVisitor[StructField]
)
...
func (p WalkPath) WalkMap(v reflect.Value, visitor WithKeyVisitor, opts ...WalkOption) error {
...
func (p WalkPath) WalkStruct(v reflect.Value, visitor WithFieldNameVisitor, opts ...WalkOption) error {
