...
func TestHasher_Hash(t *testing.T) {
	...
	var (
		emptyMapHash   = addNonUniqueHash("debcea1f166010e428df48387304e45c0bf7843a1fa7f1beb38f852228df789b")
		emptyArrayHash = addNonUniqueHash("c69a9157638e69fb692d827383c3f27e586e0c98989cffdf8bd4c982ad837a4c")
	...
	tests := []struct {
		...
		{"int max", MaxInt64, "b2ee011c9976b356989192e2b2b768032a663f7850c4f1bb1a74222cfa8827da"},
		{"uint max", MaxUint64, "fbd81d6ae8e531ac82528821e98bf76c1d5ac5ec636aececebe8bd9e691be836"},
		...
		{"map with nil value", map[string]any{"key": nil}, emptyMapHash},
		...
		{"nested empty map", map[string]any{"outer": map[string]any{}}, nestedMapNilHash},
...
func TestHasher_Hash_disallowedMapKeys(t *testing.T) {
	...
	require.ErrorContains(t, err, "key '**[1].*key2.superillegal' must not be in disallowed keys [superillegal]")
}
