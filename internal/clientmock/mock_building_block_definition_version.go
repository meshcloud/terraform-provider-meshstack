...
// output per input, with SINGLE_SELECT/MULTI_SELECT/LIST/JSON input types translated to output-compatible types).
...
// LIST and JSON cannot be output types and are translated; all other types are kept as-is.
