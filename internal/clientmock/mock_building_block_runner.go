...
// sharedBuildingBlockRunner mirrors the hosted runner every meshStack serves under
// client.SharedBuildingBlockRunnerUuid: readable by any workspace, and the runner a building block
// definition version uses when it names none. Its workload identity federation values are made up -
...
func sharedBuildingBlockRunner() *client.MeshBuildingBlockRunner {
	return &client.MeshBuildingBlockRunner{
		Metadata: client.MeshBuildingBlockRunnerMetadata{
			Uuid:             new(client.SharedBuildingBlockRunnerUuid),
