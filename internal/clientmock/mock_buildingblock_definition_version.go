...
func (m MeshBuildingBlockDefinitionVersionClient) Create(_ context.Context, versionSpec client.MeshBuildingBlockDefinitionVersionSpec) (*client.MeshBuildingBlockDefinitionVersion, error) {
...
func (m MeshBuildingBlockDefinitionVersionClient) Update(_ context.Context, uuid string, versionSpec client.MeshBuildingBlockDefinitionVersionSpec) (*client.MeshBuildingBlockDefinitionVersion, error) {
