...
var _ validator.List = SupportedPlatforms{}
...
func (v SupportedPlatforms) ValidateList(ctx context.Context, req validator.ListRequest, resp *validator.ListResponse) {
